<template>
  <v-container class="main-ctr d-flex flex-column">
    ...
    <p>
      ...
      Policy has been created with the help of the Free Privacy Policy Generator.
    </p>
    ...
    <h1 class="mt-5">Interpretation and Definitions</h1>
    ...
    <ul>
      ...
      <li>Website refers to Neat memos, accessible from https://www.realm-trove.com</li>
      <li>
        You means the individual accessing or using the Service, or the company, or other legal
        entity on behalf of which such individual is accessing or using the Service, as applicabl
      </li>
    </ul>
