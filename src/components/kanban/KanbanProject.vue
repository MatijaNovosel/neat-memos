      ...
      <template v-if="project.columns.length">
        ...
        >
          ...
          <container
            ...
            @drop="(result: DropResult<CardModel>) => onCardDrop(project.id, column.id, result)"
...
import { CardModel, ColumnModel, MovePosition, ProjectModel } from "@/models/kanban";
